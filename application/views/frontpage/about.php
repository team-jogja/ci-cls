  ...
  <div class="container">
    ...
    <div class="row wow fadeInUp align-items-center" data-wow-delay=".3s">
        <div class="col-lg-8 col-xl-6 pb-3">
            <p class="col-lg12 pb-2">
                <img class="img-fluid " src="<?= base_url('assets/img/about/images_asset2.png'); ?>"/>
            </p>
        </div>
...
<section  class="py-5 darken-4 wepro">
  <div class="container">
    <div class="wow fadeIn">
        ...
        <div class="row wow fadeInUp align-items-center" data-wow-delay=".3s">
            <div class="col-lg-8 col-xl-6 white-text">
                <p class="px-5 mb-5">
                    <h1 class=" font-bold">THE SCALE OF CLS </br> COVERAGE THAT HAS </br> BEEN DONE</h1>
            ...
            <div class="col-lg-8 col-xl-6 ">
                <p class="col-lg-12 ">
                    <img class="img-fluid " src="<?= base_url('assets/img/about/image_assets3_aboutus.png'); ?>"/>
                </p>
            </div>
        </div>
        ...
        <div class="row wow fadeInUp " data-wow-delay=".3s">
            <div class="col-lg-8 col-xl-3 pb-3">
                <div class="col-lg-8 pb-2 align-items-center img-fluid embuh1">
